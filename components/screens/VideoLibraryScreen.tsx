...
export default function VideoLibraryScreen({ onSelectVideo }: Props) {
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-4 py-2.5 rounded-xl text-sm outline-none w-64 text-white placeholder:text-gray-600"
      ...
      {/* Tab bar */}
      <div className="flex gap-1 mb-8 p-1 rounded-xl w-fit" style={{ background: '#171c24', border: '1px solid #2a3038' }}>
        {TABS.map(tab => (
          <button
            key={tab}
